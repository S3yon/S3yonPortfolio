      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative group">
            <div className="bg-text-accent text-bg-primary px-3 py-1 text-xs rounded cursor-pointer">SEYON</div>
            <div className="absolute bottom-full right-0 mb-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="bg-bg-secondary border border-border-primary rounded shadow-lg p-2 min-w-[120px]">
                <div className="flex flex-col gap-2">
                  <a
                    href="https://www.linkedin.com/in/seyon-sri/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-2 py-1 text-xs text-text-secondary hover:text-text-primary hover:bg-bg-tertiary rounded transition-all"
